...
from viewShed_utils import peaks,get_visible_area
...
size_fig = (1350*px2inch,900*px2inch) 
fig, ax  = plt.subplots(2,3,constrained_layout=True,figsize=size_fig)
data     = {'xlim':(a,b),'ylim':(a,b)}

for i,(V,A) in enumerate(zip(V_arr,A_arr)):
   ...
   ax[i].set_title(f'k factor:{K_arr[i]:d}  Area:{A:06.3f}')
