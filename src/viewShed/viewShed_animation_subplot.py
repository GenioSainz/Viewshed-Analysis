...
def get_animation_data():
    ...
    np.save('../../data/animation_data_subplot.npy', V_arr) # save
...
# Load animation data
V_arr = np.load('../../data/animation_data_subplot.npy')
...
ax[0].set_title(f'Visible Area: {area[0]:06.3f} %')
...
if run_animation:
    ...
    def animate_fun(i):
        ...
        ax[0].set_title(f'Visible Area: {area[i]:06.3f} %')
