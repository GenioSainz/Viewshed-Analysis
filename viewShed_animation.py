...
def get_animation_data():
    ...
    np.save('animation_data.npy', V_arr) # save
...
V_arr = np.load('animation_data.npy')
...
scat1 = ax[0].scatter(xi[0],yi[0],s=70,c='w',edgecolors='k',zorder=6)
...
scat2 = ax[1].scatter(dis_profile[0],zi[0],s=70,c='w',edgecolors='k',zorder=6)
